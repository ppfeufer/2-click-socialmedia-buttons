<?php
namespace PPWP\Plugin\TwoClickSocialMedia\Backend;

use PPWP\Plugin\TwoClickSocialMedia\Helper\Twoclick_Social_Media_Buttons_Pages_Walker;
/**
							...
							<div class="inside">
								...
								<div style="padding-top:25px;">
									...
									<div style="margin-left:100px;">
										...
										<div>
											<p>
												<?php _e('If you choose "Manuall (Shortcode)", you can use the shortcode <code>[twoclick_buttons]</code> inside your articles.', TWOCLICK_TEXTDOMAIN); ?><br />
												<?php _e('If you choose "Manuall (Template)", you can use the code <code>&lt;?php if(function_exists(\'\PPWP\Plugin\TwoClickSocialMedia\get_twoclick_buttons\')) {\PPWP\Plugin\TwoClickSocialMedia\get_twoclick_buttons(get_the_ID());} ?&gt;</code> inside your template. It\'s using all settings for "Display". <em><strong>Note:</strong> It will only work in single post or page templates. Not in any loop.</em>', TWOCLICK_TEXTDOMAIN); ?>
											</p>
										</div>
								...
								<div style="clear:both;">
									<div>
										...
										<select name="twoclick_buttons_settings[twoclick_buttons_facebook_action]">
											...
											<option <?php if($this->array_TwoclickButtonsOptions['twoclick_buttons_facebook_action'] == 'share') echo 'selected="selected"'; ?> value="share"><?php _e('Share', TWOCLICK_TEXTDOMAIN); ?></option>
										</select>
									</div>
								</div>
							</div>
