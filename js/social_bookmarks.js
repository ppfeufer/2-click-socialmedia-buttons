...
//		if(!facebook_on && !twitter_on && !gplus_on && !flattr_on && !xing_on && !pinterest_on && !t3n_on && !linkedin_on) {
		...
		return this.each(function() {
			...
			if(facebook_on) {
				...
				if(options.services.facebook.action == 'share') {
					var fb_code = '<a href="#" onclick="window.open(\'https://www.facebook.com/sharer/sharer.php?u=' + fb_enc_uri + '\', \'facebook-share-dialog\', \'width=626,height=436\'); return false;"><img src="' + options.services.facebook.share_img + '" alt="" /></a>';
				} else {
